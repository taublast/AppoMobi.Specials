...
public static class IEnumerableExtensions
{
    ...
    public static IEnumerable<TSource> DistinctionBy<TSource, TKey>(this IEnumerable<TSource> source, string propSelector)
    {
        ...
        return source.DistinctionBy(lambdaExp.Compile(), null);
    }

    public static IEnumerable<TSource> DistinctionBy<TSource, TKey>(this IEnumerable<TSource> source,
        Func<TSource, TKey> keySelector)
    {
        return source.DistinctionBy(keySelector, null);
    }
    ...
    public static IQueryable<TSource> DistinctionBy<TSource, TKey>(this IQueryable<TSource> source,
